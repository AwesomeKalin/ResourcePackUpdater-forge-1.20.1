...
public class GlHelper {
    ...
    private static VertexSorting lastProjectionSorting = vector3fs -> new int[0];
    ...
    public static void initGlStates() {
        ...
        // Copy current projection matrix (if needed)
        lastProjectionMat = new Matrix4f(RenderSystem.getProjectionMatrix());
        RenderSystem.setShaderColor(1f, 1f, 1f, 1f);
        // RenderSystem.enableTexture(); // Removed in 1.20.1 – no longer necessary
    ...
    public static void setMatPixel() {
        ...
        RenderSystem.setProjectionMatrix(matrix, vector3fs -> new int[0]);
    }
    ...
    public static void enableScissor(float x, float y, float width, float height) {
        Matrix4f posMap = new Matrix4f(RenderSystem.getProjectionMatrix());
        Vector4f bottomLeft = new Vector4f(x, y + height, 0, 1);
        posMap.transform(bottomLeft);
        Vector4f topRight = new Vector4f(x + width, y, 0, 1);
        posMap.transform(topRight);
